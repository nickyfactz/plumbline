...
Plumbline supports two operating tiers without a mode flag. Convention mode uses explicit phase skills, user-supplied or conventional repository artifacts, and main-thread execution. Initialized mode adds the optional project-local router and agent team. Initialization is never a prerequisite for adopting a sufficient external artifact.
