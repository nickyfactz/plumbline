...
Honor existing artifacts regardless of which workflow produced them. Ask only questions whose answers would change product behavior, scope, experience, privacy, security, destructive handling, cost, compatibility, or another hard-to-reverse choice. State the selected phase in one sentence; do direct work directly, otherwise invoke exactly one matching internal engine. Do not initialize the repository or create automatic routing.
