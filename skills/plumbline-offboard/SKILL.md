...
Read-only by default. Report whether `.agents/skills/plumbline-router/` exists, whether Plumbline-owned `.codex/agents/` files or local exclude lines exist, and which documents are project-owned rather than removable plugin residue.
