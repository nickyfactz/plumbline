...
Before dispatch or checkpoint advancement, state one lifecycle owner. An installed or enabled workflow is available capability, not active ownership; an explicitly selected competing controller owns its own checkpoint and closeout flow.
